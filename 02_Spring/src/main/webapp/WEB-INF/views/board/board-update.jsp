  ...
  <c:choose>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <form action="/board/update/${content.contentId}" method="post">
            	<input type="hidden" name="contentAuthor" value="${content.contentAuthor}"/>
	            <input type="hidden" name="contentId" value="${content.contentId}"/>
                <div class="content-title-input">
                    <input name="contentTitle" type="text" value="${content.contentTitle}" required/>

                </div>
                
				<div class="content-main-input">
					<textarea name="contentMain" id="content-main-input" required>${content.contentMain}</textarea>
				</div>
