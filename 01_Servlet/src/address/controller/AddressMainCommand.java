...
@WebServlet("/AddressMainCommand")
public class AddressMainCommand extends HttpServlet implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/Address/address-main.jsp");
