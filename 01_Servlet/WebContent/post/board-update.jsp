...
<head>
    ...
    <link rel="stylesheet" href="/SimpleProject/post/css/board-write.css">
</head>
<body>
  <c:choose>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <form action="/SimpleProject/board/updatewrite?contentid=${content.contentId}" method="post">
                <div class="content-title-input">
                    <input name="content-title" type="text" value="${content.contentTitle}" required/>

                </div>
                
				<div class="content-main-input">
					<textarea name="content-main" id="content-main-input" required>${content.contentMain}</textarea>
				</div>
